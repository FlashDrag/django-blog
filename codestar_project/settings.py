"""
Django settings for codestar_project project.
...
ALLOWED_HOSTS = ['https://django--blog.herokuapp.com/', '127.0.0.1']
...
ROOT_URLCONF = 'codestar_project.urls'
...
WSGI_APPLICATION = 'codestar_project.wsgi.application'
